  ...
  return (
    ...
    >
      <div className="relative w-12 h-12 animate-jump">
        ...
        {/* Pico */}
        <div className="absolute top-5 left-1/2 -translate-x-1/2 w-2 h-2 bg-orange-500" style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)', transform: 'translateX(-50%) rotate(180deg)' }}></div>
        {/* Aletas */}
